    ...
    setTimeout(() => {
      ...
      if (isExistingUser) {
        ...
        const newUser = {
          ...
          role: role,
          password: password,
          isNewUser: true // Flag to indicate details need to be collected
        };
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: config.gradient }}>
      ...
      <div className="relative z-10 px-4 py-5">
        ...
        <div className="flex items-center gap-2 px-4">
          <div className="flex-1 h-1.5 rounded-full" style={{ background: step === 'phone' ? 'rgba(255, 255, 255, 0.9)' : 'rgba(255, 255, 255, 0.9)' }} />
          <div className="flex-1 h-1.5 rounded-full" style={{ background: step === 'password' ? 'rgba(255, 255, 255, 0.9)' : 'rgba(255, 255, 255, 0.3)' }} />
        </div>
      </div>
