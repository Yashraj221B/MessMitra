      ...
      <div className="px-4 pt-4 pb-4" style={{ 
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-white/80" style={{ fontSize: '0.85rem' }}>View and analyze feedback</p>
          </div>
        ...
        {/* Date Navigation */}
        <div className="flex items-center justify-between p-3 rounded-xl mb-4" style={{ background: 'rgba(255,255,255,0.2)' }}>
          <button 
            onClick={() => {
