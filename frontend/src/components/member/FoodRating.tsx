      ...
      <div className="px-4 pt-4 pb-4" style={{ 
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-white/80" style={{ fontSize: '0.85rem' }}>Rate Today's Food</p>
          </div>
          ...
          {!selectedMeal ? (
            ...
            >
              <h3 className="mb-4" style={{ fontSize: '1.1rem', fontWeight: '700', color: '#1C4532' }}>
                किस meal को रेट करना है? • Select Meal
              </h3>
            ...
            >
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <div style={{ fontSize: '1.2rem', fontWeight: '700', color: meals.find(m => m.type === selectedMeal)?.color }}>
                      {meals.find(m => m.type === selectedMeal)?.name} • {meals.find(m => m.type === selectedMeal)?.englishName}
                    </div>
              ...
              <div className="mb-6">
                <h3 className="mb-3" style={{ fontSize: '1rem', fontWeight: '700', color: '#1C4532' }}>
                  ...
                  कोई सुझाव? • Any Comments? (Optional)
                </h3>
                <textarea
                  value={comment}
